...
def sort_by_date(transactions_list: list[dict], reverse: str = "True") -> list[dict]:
    """
    ...
    if reverse == "True":
        ...
        sorted_transactions = sorted(transactions_list, key=lambda transaction: transaction["date"])
